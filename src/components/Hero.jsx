      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF] text-[70px] ">Palle Dear</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop web applications, user <br className="sm:block hidden" />
            interfaces, dApps & DeFi, Dex, DAO <br className="sm:block hidden" />
            NFTs, Smart Contracts and Machine Learning.
          </p>
        </div>
      </div>
      {/* <ComputersCanvas /> */}
